...
Workspace and Nix package are **2.2.0**. Do not push or tag from agent sessions unless a maintainer explicitly asks. A Ratatui-style dashboard remains long-term (roadmap Phase 35); do not add a TUI crate without an explicit decision.
